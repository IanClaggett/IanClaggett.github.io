$(document).ready(function () {
    ...
    $("#nav-links > a:nth-child(1)").click(function () {
        $("#main").fadeOut("slow");
        $("#footer").animate({ left: '-1000px' }, "slow");
        $("#header").animate({ left: '-1000px' }, "slow", function () {
    ...
    $("#nav-links > a:nth-child(4)").click(function () {
        $("#main").fadeOut("slow");
        $("#footer").animate({ left: '-1000px' }, "slow");
        $("#header").animate({ left: '-1000px' }, "slow", function () {
    ...
    //Animating the transition to resume
    $(".actions > li:nth-child(3)").click(function () {
        $("#one").fadeOut("slow");
        $("#footer").animate({ left: '-1000px' }, "slow");
        $("#header").animate({ left: '-1000px' }, "slow", function () {
            window.location.replace("courses");
